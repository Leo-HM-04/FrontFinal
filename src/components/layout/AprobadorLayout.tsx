            ...
            <div className="flex flex-col h-full">
              <div className="text-white p-6" style={{ background: 'linear-gradient(135deg, #3B82F6 0%, #60A5FA 100%)' }}>
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-bold">Panel Aprobador</h2>
                </div>
                <div className="bg-white/15 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/90">Aprobador Bechapra</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <Link
                  href="/dashboard/aprobador/solicitudes/pendientes"
                  className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group ${
                    pathname.startsWith("/dashboard/aprobador/solicitudes/pendientes")
                      ? "bg-blue-50 text-blue-600 shadow-sm"
                      : "text-gray-700 hover:bg-blue-50 hover:text-blue-600"
                  }`}
                  onClick={() => setIsMenuOpen(false)}
                ...
                <Link
                  href="/dashboard/aprobador/solicitudes/historial"
                  className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group ${
                    pathname.startsWith("/dashboard/aprobador/solicitudes/historial")
                      ? "bg-blue-50 text-blue-600 shadow-sm"
                      : "text-gray-700 hover:bg-blue-50 hover:text-blue-600"
                  }`}
                  onClick={() => setIsMenuOpen(false)}
                >
                  ...
                  <span className="font-medium">Historial de Aprobaciones</span>
                </Link>
                <Link
                  href="/dashboard/aprobador/recurrentes"
                  className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group ${
                    pathname.startsWith("/dashboard/aprobador/recurrentes")
                      ? "bg-blue-50 text-blue-600 shadow-sm"
                      : "text-gray-700 hover:bg-blue-50 hover:text-blue-600"
                  }`}
                  onClick={() => setIsMenuOpen(false)}
                ...
                <Link
                  href="/dashboard/aprobador/perfil"
                  className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group ${
                    pathname.startsWith("/dashboard/aprobador/perfil")
                      ? "bg-blue-50 text-blue-600 shadow-sm"
                      : "text-gray-700 hover:bg-blue-50 hover:text-blue-600"
                  }`}
                  onClick={() => setIsMenuOpen(false)}

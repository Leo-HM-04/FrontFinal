...
export function SolicitanteLayout({ children }: SolicitanteLayoutProps) {
  ...
  const navItems = [
    ...
    { href: '/dashboard/solicitante/nueva-solicitud', label: 'Nueva Solicitud', icon: <PlusCircle className="w-5 h-5" /> },
    { href: '/dashboard/solicitante/mis-solicitudes', label: 'Mis Solicitudes', icon: <ClipboardList className="w-5 h-5" /> },
    { href: '/dashboard/solicitante/nuevo-viatico', label: 'Nuevo Viático', icon: <PlusCircle className="w-5 h-5" /> },

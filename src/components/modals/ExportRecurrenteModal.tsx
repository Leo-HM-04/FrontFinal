...
import { X, FileText, Table, Database, Download, Calendar, Filter, Check, Loader2, BarChart3 } from 'lucide-react';
...
export const ExportRecurrenteModal: React.FC<ExportRecurrenteModalProps> = ({
  ...
  const filterOptions = [
    { 
      value: 'dia' as const, 
      label: 'Último día', 
      description: 'Recurrentes del último día',
      icon: Calendar,
    ...
    { 
      ...
      label: 'Última semana', 
      description: 'Recurrentes de la última semana',
      icon: Calendar,
    ...
    { 
      value: 'mes' as const, 
      label: 'Último mes', 
      description: 'Recurrentes del último mes',
      icon: Calendar,
    ...
    { 
      value: 'año' as const, 
      label: 'Último año', 
      description: 'Recurrentes del último año',
      icon: Calendar,
    ...
    { 
      ...
      description: 'Todos los recurrentes disponibles',
      icon: Calendar,
          ...
          <div className="p-8">
            ...
            <div className="mb-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-xl font-semibold text-gray-900">Seleccionar período de exportación</h4>
              </div>
                    ...
                    >
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-2">
                            <span className="inline-flex items-center px-2 py-1 rounded-full bg-blue-100 text-xs font-medium text-blue-700">{option.count}</span>
                          </div>
                        </div>
                      </div>
                    </button>
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-xl font-semibold text-gray-900">Seleccionar formato de exportación</h4>
              </div>
                    ...
                    >
                      ...
                      <div className={`${option.bgColor} p-6 relative`}>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <h5 className={`font-bold text-xl ${option.textColor}`}>{option.name}</h5>
                            <p className={`text-sm ${option.subtextColor} mt-1`}>{option.description}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Card Body */}
                      <div className="p-6">
                        <p className="text-gray-600 text-sm mb-6 leading-relaxed">{option.detail}</p>

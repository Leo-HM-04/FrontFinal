        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[500px]">
            ...
            <h1 className="col-span-1 lg:col-span-2 text-5xl md:text-6xl font-extrabold leading-tight drop-shadow-lg text-white mb-4 text-center lg:text-left">
              APROBADOR - PLATAFORMA DE PAGOS
            </h1>
            {/* Columna Izquierda - Contenido */}
            <div className="text-white space-y-8">
              {/* Subtítulo */}
              <h2 className="text-2xl md:text-3xl font-semibold text-blue-200">
                Panel exclusivo para el aprobador: revisa, aprueba o rechaza solicitudes de pago.
              </h2>

              {/* Texto descriptivo profesional */}
              <div className="text-lg md:text-xl text-white/90 leading-relaxed max-w-xl text-justify">
                Bienvenido, <span className="font-bold">{user?.nombre}</span>. Este es el panel de aprobador de la plataforma de pagos Bechapra. Aquí puedes gestionar de manera eficiente las solicitudes de pago, revisar el historial de aprobaciones y mantener un control detallado de cada proceso. Todo en un entorno seguro, moderno y diseñado para optimizar tu experiencia como aprobador dentro de la organización.
              </div>
                    ...
                    >
                      <Dialog.Panel className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl border border-blue-200 flex flex-col items-center">
                        ...
                        <div className="w-full bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-900 font-mono mb-4 select-all">
                          Asunto: Solicitud de soporte plataforma Bechapra (Aprobador)

                          Hola equipo de soporte,

                          Tengo el siguiente problema o duda como aprobador:
                        ...
                        <button
                          ...
                          onClick={() => {
                            setOpenModal(false);
                            window.open('mailto:automatizaciones@bechapra.com.mx?subject=Solicitud%20de%20soporte%20plataforma%20Bechapra%20(Aprobador)&body=Hola%20equipo%20de%20soporte%2C%0A%0ATengo%20el%20siguiente%20problema%20o%20duda%20como%20aprobador%3A%0A%5BDescribe%20aqu%C3%AD%20tu%20situaci%C3%B3n%20de%20forma%20clara%20y%20breve%5D%0A%0AGracias%20de%20antemano.', '_blank');
                          }}

                ...
                <table className="min-w-max w-full divide-y divide-gray-100 text-xs md:text-sm">
                  <thead className="sticky top-0 z-10" style={{backgroundColor: '#F0F4FC'}}>
                    <tr>
                      ...
                      <SortableHeader field="tipo_pago">TIPO DE PAGO</SortableHeader>
                      <SortableHeader field="departamento" className="px-3 py-2 text-left text-blue-800 font-semibold border-b border-blue-200">DEPTO.</SortableHeader>
                      <SortableHeader field="monto" className="px-3 py-2 text-left text-blue-800 font-semibold border-b border-blue-200">MONTO</SortableHeader>
                      <SortableHeader field="fecha_limite" className="px-3 py-2 text-left text-blue-800 font-semibold border-b border-blue-200">LÍMITE</SortableHeader>
                      <SortableHeader field="fecha_creacion" className="px-3 py-2 text-left text-blue-800 font-semibold border-b border-blue-200">SOLICITUD</SortableHeader>
                      <SortableHeader field="cuenta" className="px-3 py-2 text-left text-blue-800 font-semibold border-b border-blue-200">CUENTA/TARJETA</SortableHeader>
                      <SortableHeader field="banco" className="px-3 py-2 text-left text-blue-800 font-semibold border-b border-blue-200">BANCO</SortableHeader>
                    </tr>
                  </thead>
                        ...
                        <table className="min-w-max w-full divide-y divide-gray-100 text-xs md:text-sm">
                          <thead className="sticky top-0 z-10" style={{backgroundColor: '#F0F4FC'}}>
                            <tr>
                              ...
                              <SortableHeader field="cuenta" className="px-3 py-2 text-left text-blue-800 font-semibold border-b border-blue-200">CUENTA/TARJETA</SortableHeader>
                              <SortableHeader field="banco" className="px-3 py-2 text-left text-blue-800 font-semibold border-b border-blue-200">BANCO</SortableHeader>
                              <SortableHeader className="px-2 py-2 text-left text-blue-800 font-semibold border-b border-blue-200">Acciones</SortableHeader>
                            </tr>
                          </thead>
                          <tbody className="bg-white divide-y divide-gray-100">
                            {paginadas.map((s) => {

        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[500px]">
            ...
            <h1 className="col-span-1 lg:col-span-2 text-5xl md:text-6xl font-extrabold leading-tight drop-shadow-lg text-white mb-4 text-center lg:text-left">
              SOLICITANTE - PLATAFORMA DE PAGOS
            </h1>
            {/* Columna Izquierda - Contenido */}
            <div className="text-white space-y-8">
              {/* Subtítulo */}
              <h2 className="text-2xl md:text-3xl font-semibold text-blue-200">
                Panel exclusivo para solicitantes: crea, gestiona y haz seguimiento a tus solicitudes de pago.
              </h2>

              {/* Texto descriptivo profesional */}
              <div className="text-lg md:text-xl text-white/90 leading-relaxed max-w-xl text-justify">
                Este panel te permite crear y gestionar solicitudes de pago de forma sencilla y segura. Accede a herramientas para el control de tus plantillas recurrentes y consulta el estado de cada operación en tiempo real. Disfruta de una experiencia moderna, eficiente y adaptada a tus necesidades como solicitante.
              </div>
...
Asunto: Solicitud de soporte plataforma Bechapra (Solicitante)

Hola equipo de soporte,

Tengo el siguiente problema o duda como solicitante:
...
Gracias de antemano.
                        ...
                        <button
                          ...
                          onClick={() => {
                            setOpenModal(false);
                            window.open('mailto:automatizaciones@bechapra.com.mx?subject=Solicitud%20de%20soporte%20plataforma%20Bechapra%20(Solicitante)&body=Hola%20equipo%20de%20soporte%2C%0A%0ATengo%20el%20siguiente%20problema%20o%20duda%20como%20solicitante%3A%0A%5BDescribe%20aqu%C3%AD%20tu%20situaci%C3%B3n%20de%20forma%20clara%20y%20breve%5D%0A%0AGracias%20de%20antemano.', '_blank');
                          }}

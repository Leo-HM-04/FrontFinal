...
const useAuth = () => {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        // Verificación simple sin redirección automática
        const userData = { 
          nombre: 'Admin User', 
          rol: 'admin_general' 
        };
        ...
        // Solo redirigir si hay error de autenticación
...
const ProtectedRoute = ({ children, requiredRoles }) => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{background: 'linear-gradient(135deg, #004AB7 0%, #0057D9 100%)'}}>

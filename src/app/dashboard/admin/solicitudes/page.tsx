...
import { FileText, Trash2, Edit, ArrowLeft, Menu, LogOut, Eye } from 'lucide-react';
                          ...
                          <tr key={solicitud.id_solicitud} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                              <Button 
                                variant="outline" 
                                size="sm"
                                onClick={() => window.location.href = `/dashboard/admin/solicitudes/${solicitud.id_solicitud}`}
                              ...
                              <Button 
                                variant="outline" 
                                size="sm"
                                onClick={() => window.location.href = `/dashboard/admin/solicitudes/${solicitud.id_solicitud}/edit`}
